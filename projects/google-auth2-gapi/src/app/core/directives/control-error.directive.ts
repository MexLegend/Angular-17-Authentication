...
import { ControlErrorComponent } from '@shared/google-auth2-gapi/components/control-error/control-error.component';
import { getFormControlError } from '@core/google-auth2-gapi/helpers';
